...
namespace Taxi.Nderrime
{
    partial class ShtoNderrime
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ShtoNderrime));
            ...
            // bntRuaj
            // 
            resources.ApplyResources(this.bntRuaj, "bntRuaj");
            ...
            // lblAutomjeti
            // 
            resources.ApplyResources(this.lblAutomjeti, "lblAutomjeti");
            ...
            // cmbAutomjetiId
            // 
            resources.ApplyResources(this.cmbAutomjetiId, "cmbAutomjetiId");
            this.cmbAutomjetiId.FormattingEnabled = true;
            this.cmbAutomjetiId.Name = "cmbAutomjetiId";
            // 
            // cmbShoferiId
            // 
            resources.ApplyResources(this.cmbShoferiId, "cmbShoferiId");
            this.cmbShoferiId.FormattingEnabled = true;
            this.cmbShoferiId.Name = "cmbShoferiId";
            // 
            // lblFilimiNdrimit
            // 
            resources.ApplyResources(this.lblFilimiNdrimit, "lblFilimiNdrimit");
            this.lblFilimiNdrimit.Name = "lblFilimiNdrimit";
            // 
            // lblMbarimiNdrrimit
            // 
            resources.ApplyResources(this.lblMbarimiNdrrimit, "lblMbarimiNdrrimit");
            this.lblMbarimiNdrrimit.Name = "lblMbarimiNdrrimit";
            // 
            // dtpFillimiINderrimit
            // 
            resources.ApplyResources(this.dtpFillimiINderrimit, "dtpFillimiINderrimit");
            ...
            // 
            resources.ApplyResources(this.dtpMbarimiINderrimir, "dtpMbarimiINderrimir");
